...
public class NorthAmericanGameServer extends ServerPOA implements Runnable {
	...
	protected NorthAmericanGameServer() {
		...
		String fifthkey = "M";
		Account account5 = new Account("Mahandra", "Dhoni", "33", "MDNORTH", "DhoniM", "182.1.2.3");
	...
	private ORB northAmericanORB;

	public void setORB(ORB orb_val) {
		northAmericanORB = orb_val;
	}

	public void shutDown() {
		northAmericanORB.shutdown(false);
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			NorthAmericanGameServer northAmericanGameServer = new NorthAmericanGameServer();
			northAmericanGameServer.setORB(orb);

			// get object reference from the servant
			org.omg.CORBA.Object ref = rootpoa.servant_to_reference(northAmericanGameServer);
			...
			// Use NamingContextExtwhich is part of the Interoperable Naming Service (INS)
			// specification.
			NamingContextExt ncRef = NamingContextExtHelper.narrow(objRef);

			// bind the Object Reference in Naming
			String name = "NorthAmerican_Server";
			NameComponent path[] = ncRef.to_name(name);
			ncRef.rebind(path, href);
			System.out.println("North American Server ready and waiting ...");
		...
		System.out.println("North American Server Exiting ...");
